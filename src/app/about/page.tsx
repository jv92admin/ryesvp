      ...
      <main className="min-h-screen bg-[var(--bg-primary)]">
        ...
        <section className="bg-[var(--bg-primary)]">
          <div className="max-w-2xl mx-auto px-6 py-10">
            <p className="text-xl text-center text-[var(--accent)] font-semibold leading-relaxed mb-6">
              I built Lark for my friends
              <br />
              <span className="text-[var(--lark-text-secondary)] font-normal">(and maybe yours)</span>
            </p>
            <p className="text-[var(--lark-text-secondary)] leading-relaxed mb-4">
            ...
            <p className="text-[var(--lark-text-secondary)] leading-relaxed">
        ...
        <section className="max-w-4xl mx-auto px-6 py-12">
          <h2 className="text-2xl font-bold text-[var(--lark-text-primary)] text-center mb-3">
            How It Works
          </h2>
          <p className="text-center text-[var(--lark-text-secondary)] mb-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-2 mb-4">
                <span className="text-sm font-bold text-[var(--lark-text-primary)] uppercase tracking-wider">
                  Discover
                </span>
                <span className="text-[var(--lark-text-muted)]">|</span>
                <span className="text-sm font-medium text-[var(--lark-text-primary)]">
                  Find what&apos;s happening
                </span>
              </div>
              <div className="relative w-[200px] h-[360px] mx-auto rounded-2xl overflow-hidden border border-[var(--border-subtle)] bg-[var(--bg-surface)] mb-4">
                <Image
              ...
              <p className="text-[var(--lark-text-secondary)] text-sm leading-relaxed max-w-[240px] mx-auto">
          ...
          {/* Go - elegant card with accent */}
          <div className="text-center py-10 mt-8 bg-[var(--bg-elevated)] rounded-2xl border-2 border-[var(--accent)]">
            <h3 className="text-2xl md:text-3xl font-medium text-[var(--lark-text-primary)]">
              Then just… <span className="font-bold text-[var(--accent)]">Go.</span>
            </h3>
          </div>
        </section>
        ...
        <section className="bg-[var(--bg-surface)] border-y border-[var(--border-subtle)]">
          <div className="max-w-2xl mx-auto px-6 py-12">
            <h2 className="text-xl font-bold text-[var(--lark-text-primary)] mb-2">
              What I&apos;m working on next
            </h2>
            <p className="text-sm text-[var(--lark-text-secondary)] mb-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-[var(--lark-text-secondary)] text-sm leading-relaxed">
              ...
              <div className="pt-6 border-t border-[var(--border-subtle)]">
                ...
                <p className="text-[var(--lark-text-secondary)] text-sm leading-relaxed mb-4">
                ...
                <a
                  href="mailto:vignesh.jeyaraman@gmail.com"
                  className="inline-flex items-center gap-2 px-4 py-2 text-base font-medium text-[var(--lark-text-primary)] bg-[var(--bg-surface)] rounded-lg hover:bg-[var(--bg-hover)] transition-colors"
                >
